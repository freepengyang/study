namespace TABLE
{
	...
	public static class WARDROBEHelper
	{
		public static void Encode(this System.IO.Stream stream,WARDROBE item)
		{
	...
	public class WARDROBEARRAY  : ILFastMode
	{
		public WARDROBEARRAY()
		{
		...
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.WARDROBE randAttr = new TABLE.WARDROBE();
				handle = handles[i];
