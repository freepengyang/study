namespace TABLE
{
	...
	{
		public static void Encode(this System.IO.Stream stream,ATTRIBUTE item)
		{
	...
	public class ATTRIBUTEARRAY  : ILFastMode
	{
		...
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.ATTRIBUTE randAttr = new TABLE.ATTRIBUTE();
				handle = handles[i];
