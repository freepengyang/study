namespace TABLE
{
	...
	{
		public static void Encode(this System.IO.Stream stream,TIMER item)
		{
			...
			stream.Encode(item.dayRest);
		}
	}
	public class TIMERARRAY  : ILFastMode
	{
		public TIMERARRAY()
		{
			...
			Rules = new byte[]{1,1,2,2,1,2,2,1};
		}
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.TIMER randAttr = new TABLE.TIMER();
				handle = handles[i];
