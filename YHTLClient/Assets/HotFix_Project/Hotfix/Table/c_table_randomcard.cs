namespace TABLE
{
	...
	public static class RANDOMCARDHelper
	{
		public static void Encode(this System.IO.Stream stream,RANDOMCARD item)
		{
			stream.Encode(item.id);
			stream.Encode(item.library);
			stream.Encode(item.quality);
			stream.Encode(item.max);
			stream.Encode(item.cardid);
		}
	}
	public class RANDOMCARDARRAY  : ILFastMode
	{
		public RANDOMCARDARRAY()
		{
		...
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.RANDOMCARD randAttr = new TABLE.RANDOMCARD();
				handle = handles[i];
