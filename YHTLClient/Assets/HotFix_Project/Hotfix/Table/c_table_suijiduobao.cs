namespace TABLE
{
	public partial class SUIJIDUOBAO
	{
	...
	public static class SUIJIDUOBAOHelper
	{
		public static void Encode(this System.IO.Stream stream,SUIJIDUOBAO item)
		{
	...
	public class SUIJIDUOBAOARRAY  : ILFastMode
	{
		public SUIJIDUOBAOARRAY()
		{
		...
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.SUIJIDUOBAO randAttr = new TABLE.SUIJIDUOBAO();
				handle = handles[i];
