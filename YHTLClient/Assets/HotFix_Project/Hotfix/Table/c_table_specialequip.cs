namespace TABLE
{
	public partial class SPECIALEQUIP
	{
	...
	public static class SPECIALEQUIPHelper
	{
		public static void Encode(this System.IO.Stream stream,SPECIALEQUIP item)
		{
			stream.Encode(item.id);
			stream.Encode(item.type);
			stream.Encode(item.attr);
			stream.Encode(item.longji);
			stream.Encode(item.longli1);
			stream.Encode(item.longli2);
		}
	}
	public class SPECIALEQUIPARRAY  : ILFastMode
	{
		public SPECIALEQUIPARRAY()
		{
		...
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.SPECIALEQUIP randAttr = new TABLE.SPECIALEQUIP();
				handle = handles[i];
