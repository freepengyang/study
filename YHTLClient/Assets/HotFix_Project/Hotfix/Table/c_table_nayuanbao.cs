namespace TABLE
{
	public partial class NAYUANBAO
	{
	...
	public static class NAYUANBAOHelper
	{
		public static void Encode(this System.IO.Stream stream,NAYUANBAO item)
		{
	...
	public class NAYUANBAOARRAY  : ILFastMode
	{
		public NAYUANBAOARRAY()
		{
			LongValueFixedLength = 0;
			IntValueFixedLength = 7;
			StringValueFixedLength = 2;
			Rules = new byte[]{1,1,1,2,2,1,1,1,1};
		}
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.NAYUANBAO randAttr = new TABLE.NAYUANBAO();
				handle = handles[i];
