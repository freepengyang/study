namespace TABLE
{
	...
	{
		public static void Encode(this System.IO.Stream stream,DESCRIPTION item)
		{
			stream.Encode(item.id);
			stream.Encode(item.Description);
			stream.Encode(item.Section);
			stream.Encode(item.Title);
		}
	}
	public class DESCRIPTIONARRAY  : ILFastMode
	{
		...
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.DESCRIPTION randAttr = new TABLE.DESCRIPTION();
				handle = handles[i];
