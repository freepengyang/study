namespace TABLE
{
	public partial class RANKAWARDS
	{
	...
	public static class RANKAWARDSHelper
	{
		public static void Encode(this System.IO.Stream stream,RANKAWARDS item)
		{
	...
	public class RANKAWARDSARRAY  : ILFastMode
	{
		public RANKAWARDSARRAY()
		{
			LongValueFixedLength = 0;
			IntValueFixedLength = 6;
			StringValueFixedLength = 1;
			Rules = new byte[]{1,1,1,2,1,1,1};
		}
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.RANKAWARDS randAttr = new TABLE.RANKAWARDS();
				handle = handles[i];
