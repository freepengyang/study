namespace TABLE
{
	...
	{
		public static void Encode(this System.IO.Stream stream,MBOX item)
		{
	...
	public class MBOXARRAY  : ILFastMode
	{
		public MBOXARRAY()
		{
			...
			Rules = new byte[]{1,1,1,1,2,2,2,1,1,1};
		}
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.MBOX randAttr = new TABLE.MBOX();
				handle = handles[i];
