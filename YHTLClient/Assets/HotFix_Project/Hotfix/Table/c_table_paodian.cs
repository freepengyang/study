namespace TABLE
{
	...
	public static class PAODIANHelper
	{
		public static void Encode(this System.IO.Stream stream,PAODIAN item)
		{
	...
	public class PAODIANARRAY  : ILFastMode
	{
		public PAODIANARRAY()
		{
			...
			Rules = new byte[]{1,1,1,1,1,1,2,1,2};
		}
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.PAODIAN randAttr = new TABLE.PAODIAN();
				handle = handles[i];
