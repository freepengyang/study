namespace TABLE
{
	public partial class INSTANCEDROPSHOW
	{
	...
	public static class INSTANCEDROPSHOWHelper
	{
		public static void Encode(this System.IO.Stream stream,INSTANCEDROPSHOW item)
		{
			stream.Encode(item.id);
			stream.Encode(item.instanceId);
			stream.Encode(item.min);
			stream.Encode(item.max);
			stream.Encode(item.groupId);
		}
	}
	public class INSTANCEDROPSHOWARRAY  : ILFastMode
	{
		public INSTANCEDROPSHOWARRAY()
		{
		...
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.INSTANCEDROPSHOW randAttr = new TABLE.INSTANCEDROPSHOW();
				handle = handles[i];
