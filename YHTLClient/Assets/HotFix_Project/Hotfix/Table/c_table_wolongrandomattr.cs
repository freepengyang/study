namespace TABLE
{
	public partial class WOLONGRANDOMATTR
	{
	...
	public static class WOLONGRANDOMATTRHelper
	{
		public static void Encode(this System.IO.Stream stream,WOLONGRANDOMATTR item)
		{
	...
	public class WOLONGRANDOMATTRARRAY  : ILFastMode
	{
		public WOLONGRANDOMATTRARRAY()
		{
			LongValueFixedLength = 0;
			IntValueFixedLength = 5;
			StringValueFixedLength = 1;
			Rules = new byte[]{1,1,1,1,1,2};
		}
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.WOLONGRANDOMATTR randAttr = new TABLE.WOLONGRANDOMATTR();
				handle = handles[i];
