namespace TABLE
{
	public partial class HEJISKILL
	{
	...
	public static class HEJISKILLHelper
	{
		public static void Encode(this System.IO.Stream stream,HEJISKILL item)
		{
			stream.Encode(item.id);
			stream.Encode(item.skillGroup);
			stream.Encode(item.level);
			stream.Encode(item.costPoint);
			stream.Encode(item.maxPoint);
			stream.Encode(item.minPoint);
		}
	}
	public class HEJISKILLARRAY  : ILFastMode
	{
		public HEJISKILLARRAY()
		{
		...
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.HEJISKILL randAttr = new TABLE.HEJISKILL();
				handle = handles[i];
