namespace TABLE
{
	public partial class BOSSDROPSHOW
	{
	...
	public static class BOSSDROPSHOWHelper
	{
		public static void Encode(this System.IO.Stream stream,BOSSDROPSHOW item)
		{
	...
	public class BOSSDROPSHOWARRAY  : ILFastMode
	{
		public BOSSDROPSHOWARRAY()
		{
			LongValueFixedLength = 0;
			IntValueFixedLength = 5;
			StringValueFixedLength = 1;
			Rules = new byte[]{1,1,2,1,1,1};
		}
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.BOSSDROPSHOW randAttr = new TABLE.BOSSDROPSHOW();
				handle = handles[i];
