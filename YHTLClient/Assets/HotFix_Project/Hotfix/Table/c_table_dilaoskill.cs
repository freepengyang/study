namespace TABLE
{
	public partial class DILAOSKILL
	{
	...
	public static class DILAOSKILLHelper
	{
		public static void Encode(this System.IO.Stream stream,DILAOSKILL item)
		{
			stream.Encode(item.id);
			stream.Encode(item.creer);
			stream.Encode(item.skill);
			stream.Encode(item.level);
			stream.Encode(item.rate);
		}
	}
	public class DILAOSKILLARRAY  : ILFastMode
	{
		public DILAOSKILLARRAY()
		{
		...
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.DILAOSKILL randAttr = new TABLE.DILAOSKILL();
				handle = handles[i];
