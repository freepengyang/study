namespace TABLE
{
	public partial class ITEMOPERATE
	{
	...
	public static class ITEMOPERATEHelper
	{
		public static void Encode(this System.IO.Stream stream,ITEMOPERATE item)
		{
			stream.Encode(item.id);
			stream.Encode(item.itemType);
			stream.Encode(item.secondType);
			stream.Encode(item.Operationtype);
			stream.Encode(item.leftOperate);
			stream.Encode(item.rightOperate);
		}
	}
	public class ITEMOPERATEARRAY  : ILFastMode
	{
		public ITEMOPERATEARRAY()
		{
		...
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.ITEMOPERATE randAttr = new TABLE.ITEMOPERATE();
				handle = handles[i];
