namespace TABLE
{
	public partial class TASKREWARDS
	{
	...
	public static class TASKREWARDSHelper
	{
		public static void Encode(this System.IO.Stream stream,TASKREWARDS item)
		{
	...
	public class TASKREWARDSARRAY  : ILFastMode
	{
		public TASKREWARDSARRAY()
		{
		...
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.TASKREWARDS randAttr = new TABLE.TASKREWARDS();
				handle = handles[i];
