namespace TABLE
{
	public partial class WOLONGSCORE
	{
	...
	public static class WOLONGSCOREHelper
	{
		public static void Encode(this System.IO.Stream stream,WOLONGSCORE item)
		{
			...
			stream.Encode(item.valueType);
			stream.Encode(item.valueMin);
			stream.Encode(item.valueMax);
		}
	}
	public class WOLONGSCOREARRAY  : ILFastMode
	{
		public WOLONGSCOREARRAY()
		{
		...
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.WOLONGSCORE randAttr = new TABLE.WOLONGSCORE();
				handle = handles[i];
