namespace TABLE
{
	public partial class UNDERGROUNDTREASUREHUNT
	{
	...
	public static class UNDERGROUNDTREASUREHUNTHelper
	{
		public static void Encode(this System.IO.Stream stream,UNDERGROUNDTREASUREHUNT item)
		{
	...
	public class UNDERGROUNDTREASUREHUNTARRAY  : ILFastMode
	{
		public UNDERGROUNDTREASUREHUNTARRAY()
		{
			LongValueFixedLength = 0;
			IntValueFixedLength = 5;
			StringValueFixedLength = 1;
			Rules = new byte[]{1,1,1,1,2,1};
		}
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.UNDERGROUNDTREASUREHUNT randAttr = new TABLE.UNDERGROUNDTREASUREHUNT();
				handle = handles[i];
