namespace TABLE
{
	public partial class CHONGZHUTOPCOST
	{
	...
	public static class CHONGZHUTOPCOSTHelper
	{
		public static void Encode(this System.IO.Stream stream,CHONGZHUTOPCOST item)
		{
			...
			stream.Encode(item.costItemID2);
			stream.Encode(item.num2);
		}
	}
	public class CHONGZHUTOPCOSTARRAY  : ILFastMode
	{
		public CHONGZHUTOPCOSTARRAY()
		{
		...
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.CHONGZHUTOPCOST randAttr = new TABLE.CHONGZHUTOPCOST();
				handle = handles[i];
