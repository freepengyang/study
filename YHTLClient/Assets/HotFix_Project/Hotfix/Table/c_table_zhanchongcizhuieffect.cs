namespace TABLE
{
	public partial class ZHANCHONGCIZHUIEFFECT
	{
	...
	public static class ZHANCHONGCIZHUIEFFECTHelper
	{
		public static void Encode(this System.IO.Stream stream,ZHANCHONGCIZHUIEFFECT item)
		{
	...
	public class ZHANCHONGCIZHUIEFFECTARRAY  : ILFastMode
	{
		public ZHANCHONGCIZHUIEFFECTARRAY()
		{
			LongValueFixedLength = 0;
			IntValueFixedLength = 6;
			StringValueFixedLength = 2;
			Rules = new byte[]{1,1,1,1,1,1,2,2};
		}
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.ZHANCHONGCIZHUIEFFECT randAttr = new TABLE.ZHANCHONGCIZHUIEFFECT();
				handle = handles[i];
