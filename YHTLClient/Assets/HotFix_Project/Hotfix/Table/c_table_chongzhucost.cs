namespace TABLE
{
	public partial class CHONGZHUCOST
	{
	...
	public static class CHONGZHUCOSTHelper
	{
		public static void Encode(this System.IO.Stream stream,CHONGZHUCOST item)
		{
	...
	public class CHONGZHUCOSTARRAY  : ILFastMode
	{
		public CHONGZHUCOSTARRAY()
		{
		...
		public override void Decode(byte[] contents)
		{
			...
			{
				TABLE.CHONGZHUCOST randAttr = new TABLE.CHONGZHUCOST();
				handle = handles[i];
