...
public class TaskConditionTrigger : IConditionTrigger
{
    ...
    public bool Condition(object argv)
    {
        ...
        if (guideItemData.triggerTaskId > 0 && guideItemData.triggerTaskId != mission.TaskId)
        {
            return false;
        }

        if((int)mission.TaskState != guideItemData.triggerStatus && guideItemData.triggerStatus >= 0)
        {
            return false;
        }
