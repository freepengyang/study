public class DirectPurchaseGiftRedPointCheck : RedPointCheckBase
{
    ...
    {
        RefreshRed(RedPointType.DirectPurchaseGift,CSDirectPurchaseInfo.Instance.IsHasEnoughYuanBao());
    }
