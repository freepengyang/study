public class HandBookSetupedUpgradeQualityRedPointCheck : RedPointCheckBase
{
    ...
    protected void OnCheckRedPoint(uint id, object argv)
    {
        ...
        RefreshRed(RedPointType.HandBookSetupedUpgradeQuality, CSHandBookManager.Instance.CheckHandBookSetupedUpgradeQualityRedPoint(out handBookSlotData));
    }
