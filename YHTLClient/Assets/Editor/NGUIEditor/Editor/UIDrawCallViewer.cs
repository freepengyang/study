	...
	void OnGUI ()
	{
		...
		for (int i = 0; i < dcs.size; ++i)
		{
			...
			if (NGUIEditorTools.DrawHeader(name, key))
			{
				...
				{
					EditorGUILayout.HelpBox("You must switch this material's shader to Unlit/Transparent Colored or Unlit/Premultiplied Colored in stage for clipping to work.",
						MessageType.Warning);
				}
