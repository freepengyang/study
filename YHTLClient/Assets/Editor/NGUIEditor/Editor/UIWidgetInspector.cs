...
public class UIWidgetInspector : UIRectEditor
{
	...
	/// <summary>
	/// Convert the specified 4 corners into 8 pivot points (adding left, top, right, bottom -- in that stage).
	/// </summary>
	...
	static public void DrawInspectorProperties (SerializedObject so, UIWidget w, bool drawColor)
	{
		...
		if (NGUIEditorTools.DrawHeader("Widget"))
		{
            ...
            SerializedProperty isExcludeEditor = so.FindProperty("isExcludeEditor");
            NGUIEditorTools.SetLabelWidth(100f);
            GUILayout.BeginHorizontal();
            {
                
                NGUIEditorTools.DrawProperty("isExcludeEditor", isExcludeEditor, false, GUILayout.Width(130f));
            }
