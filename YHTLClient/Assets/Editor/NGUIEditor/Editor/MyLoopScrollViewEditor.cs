...
[CustomEditor(typeof(MyLoopScrollView), true)]


public class MyLoopScrollViewEditor : UIWidgetContainerEditor
{
    MyLoopScrollView mLoopScrollView;
    void OnEnable()
    {
        mLoopScrollView = target as MyLoopScrollView;
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        mLoopScrollView.arrangeDirection = (MyLoopScrollView.ArrangeDirection)EditorGUILayout.EnumPopup("ArrangeDirection", mLoopScrollView.arrangeDirection);
