...
public class TextureImportSetting : EditorWindow
{
    ...
    //Filter Mode
    private int NpotScaleInt = 0;
    private string[] NpotScaleString = new string[] { "None", "ToLarger", "ToNearest", "ToSmaller" };
    //Wrap Mode
    ...
    /// 创建、显示窗体
    /// </summary>
    [@MenuItem("Game/Texture Import Settings")]
    ...
    private void OnGUI()
    {
        ...
        NpotScaleInt = EditorGUILayout.IntPopup("NpotScale Mode", NpotScaleInt, NpotScaleString, IntArray);
        //Wrap Mode
