...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UIGrid_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, GetChildList_1);
            args = new Type[]{typeof(System.Boolean)};
            method = type.GetMethod("set_repositionNow", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_repositionNow_2);
            ...
            app.RegisterCLRFieldGetter(field, get_maxPerLine_0);
            app.RegisterCLRFieldSetter(field, set_maxPerLine_0);
            app.RegisterCLRFieldBinding(field, CopyToStack_maxPerLine_0, AssignFromStack_maxPerLine_0);
        ...
        static StackObject* GetChildList_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* set_repositionNow_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static object get_maxPerLine_0(ref object o)
        {
            return ((global::UIGrid)o).maxPerLine;
        }

        static StackObject* CopyToStack_maxPerLine_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static void set_maxPerLine_0(ref object o, object v)
        {
            ((global::UIGrid)o).maxPerLine = (System.Int32)v;
        }

        static StackObject* AssignFromStack_maxPerLine_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
