...
{
    unsafe class SpringPosition_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(global::SpringPosition);
        ...
        {
            ((global::SpringPosition)o).target = (UnityEngine.Vector3)v;
        }
        ...
        static StackObject* AssignFromStack_target_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ...
            ((global::SpringPosition)o).target = @target;
