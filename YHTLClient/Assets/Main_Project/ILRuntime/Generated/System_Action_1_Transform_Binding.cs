...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Action_1_Transform_Binding
    {
        ...
        static StackObject* Invoke_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Action<UnityEngine.Transform> instance_of_this_method = (System.Action<UnityEngine.Transform>)typeof(System.Action<UnityEngine.Transform>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
