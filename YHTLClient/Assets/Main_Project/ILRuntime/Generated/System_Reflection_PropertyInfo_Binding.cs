...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Reflection_PropertyInfo_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.Reflection.PropertyInfo), typeof(System.Reflection.PropertyInfo)};
            method = type.GetMethod("op_Inequality", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, op_Inequality_0);
            args = new Type[]{};
            method = type.GetMethod("GetGetMethod", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetGetMethod_1);
        ...
        static StackObject* GetGetMethod_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
