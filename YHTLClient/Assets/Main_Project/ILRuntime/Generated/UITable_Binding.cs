...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UITable_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_repositionNow_0);
            args = new Type[]{};
            method = type.GetMethod("Reposition", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Reposition_1);
            args = new Type[]{};
        ...
        static StackObject* set_repositionNow_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* Reposition_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
