...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_MonoBehaviour_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, StopAllCoroutines_1);
            args = new Type[]{};
            ...
            method = type.GetMethod("StopCoroutine", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, StopCoroutine_4);
        ...
        static StackObject* StopAllCoroutines_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* StopCoroutine_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
