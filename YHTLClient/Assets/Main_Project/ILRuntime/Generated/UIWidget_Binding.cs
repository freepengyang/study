...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UIWidget_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_width_0);
            args = new Type[]{typeof(System.Int32)};
            ...
            app.RegisterCLRMethodRedirection(method, set_mainTexture_3);
            args = new Type[]{};
            method = type.GetMethod("MakePixelPerfect", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, MakePixelPerfect_4);
            args = new Type[]{};
            method = type.GetMethod("get_height", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_height_5);
            args = new Type[]{};
            method = type.GetMethod("get_pivotOffset", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_pivotOffset_6);
            args = new Type[]{};
            method = type.GetMethod("get_localSize", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_localSize_7);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, get_material_10);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, set_depth_14);

            field = type.GetField("autoResizeBoxCollider", flag);
            app.RegisterCLRFieldGetter(field, get_autoResizeBoxCollider_0);
            app.RegisterCLRFieldSetter(field, set_autoResizeBoxCollider_0);
            app.RegisterCLRFieldBinding(field, CopyToStack_autoResizeBoxCollider_0, AssignFromStack_autoResizeBoxCollider_0);


        }


        static StackObject* set_width_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* set_mainTexture_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* MakePixelPerfect_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* get_pivotOffset_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = instance_of_this_method.pivotOffset;
        ...
        static StackObject* get_localSize_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_material_10(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_color_11(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* set_depth_14(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static object get_autoResizeBoxCollider_0(ref object o)
        {
            return ((global::UIWidget)o).autoResizeBoxCollider;
        }

        static StackObject* CopyToStack_autoResizeBoxCollider_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((global::UIWidget)o).autoResizeBoxCollider;
            __ret->ObjectType = ObjectTypes.Integer;
            __ret->Value = result_of_this_method ? 1 : 0;
            return __ret + 1;
        }

        static void set_autoResizeBoxCollider_0(ref object o, object v)
        {
            ((global::UIWidget)o).autoResizeBoxCollider = (System.Boolean)v;
        }

        static StackObject* AssignFromStack_autoResizeBoxCollider_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            System.Boolean @autoResizeBoxCollider = ptr_of_this_method->Value == 1;
            ((global::UIWidget)o).autoResizeBoxCollider = @autoResizeBoxCollider;
