...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UIProgressBar_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_alpha_2);
            args = new Type[]{typeof(global::UIProgressBar.FillDirection)};
            method = type.GetMethod("set_fillDirection", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_fillDirection_3);

            field = type.GetField("onDragFinished", flag);
            app.RegisterCLRFieldGetter(field, get_onDragFinished_0);
            app.RegisterCLRFieldSetter(field, set_onDragFinished_0);
            app.RegisterCLRFieldBinding(field, CopyToStack_onDragFinished_0, AssignFromStack_onDragFinished_0);
        ...
        static StackObject* get_alpha_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* set_fillDirection_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            global::UIProgressBar.FillDirection @value = (global::UIProgressBar.FillDirection)typeof(global::UIProgressBar.FillDirection).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            instance_of_this_method.fillDirection = value;

            return __ret;
        }


        static object get_onDragFinished_0(ref object o)
        {
            return ((global::UIProgressBar)o).onDragFinished;
        }

        static StackObject* CopyToStack_onDragFinished_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((global::UIProgressBar)o).onDragFinished;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_onDragFinished_0(ref object o, object v)
        {
            ((global::UIProgressBar)o).onDragFinished = (global::UIProgressBar.OnDragFinished)v;
        }

        static StackObject* AssignFromStack_onDragFinished_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            global::UIProgressBar.OnDragFinished @onDragFinished = (global::UIProgressBar.OnDragFinished)typeof(global::UIProgressBar.OnDragFinished).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ((global::UIProgressBar)o).onDragFinished = @onDragFinished;
