...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_TimeZoneInfo_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("ConvertTime", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ConvertTime_1);
        ...
        static StackObject* ConvertTime_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            ...
            var result_of_this_method = System.TimeZoneInfo.ConvertTime(@dateTime, @destinationTimeZone);
