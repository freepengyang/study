...
{
    unsafe class UnityEngine_Networking_DownloadHandlerTexture_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.Networking.DownloadHandlerTexture);
        ...
        static StackObject* GetContent_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UnityEngine.Networking.DownloadHandlerTexture.GetContent(@www);
