...
{
    unsafe class CSMoveToTargetPos_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::CSMoveToTargetPos);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(global::AvatarUnit), typeof(UnityEngine.Vector3), typeof(System.Action), typeof(System.Action)};
            method = type.GetMethod("BeginMove", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, BeginMove_2);
            args = new Type[]{};
        ...
        static StackObject* Update_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            global::CSMoveToTargetPos instance_of_this_method = (global::CSMoveToTargetPos)typeof(global::CSMoveToTargetPos).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* BeginMove_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Action @moveUpdateAction = (System.Action)typeof(System.Action).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.Action @moveFinishAction = (System.Action)typeof(System.Action).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            instance_of_this_method.BeginMove(@avatar, @target, @moveFinishAction, @moveUpdateAction);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new global::CSMoveToTargetPos();
