...
public interface ISFResourceManager
{
    ...
    CSResource AddQueue(string name, int type, Action<CSResource> onLoadCallBack,
    ...
    string GetIsLoadLocalResPath(string applicationDataPath, int LocalType, string fileName, bool isAssetBundle, string assetbunldeStr);
}
