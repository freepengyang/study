...
public class CSLine {
    ...
    {
        if (!mIsShow) return;
        //if (mLine == null || !SFOut.IGame.IsLanuchMainPlayer) return;
        //ISFAvater avatar1 = null;/*SFOut.IScene.getAvatarByISFAvatar(avatarID1)*/
        ...
        //    return;
        //}
        //ISFAvater avatar2 = null /*SFOut.IScene.getAvatarByISFAvatar(avatarID2)*/;
        ...
        //CSMisc.Dot2 dot = avatar1.getOldCellPos - avatar2.getOldCellPos;
        //int dist = dot.Pow2();
