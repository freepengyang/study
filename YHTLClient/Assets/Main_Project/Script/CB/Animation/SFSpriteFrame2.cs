...
{
    public override void SetAtlasPostProc(/*ISFAvater IAvatar*/)
    {
        base.SetAtlasPostProc(/*IAvatar*/);
        if (mCurrentNames.Count > 0)
        {
            ...
            else if (StopFrame == EActionStopFrameType.First)
            {
                curFrame = 0;
                mSprite.SpriteName = mCurrentNames[curFrame];
            }
    ...
    {
        //TODO:ddn
        //UnityEngine.Debug.Log("======> OnNoLoopPlayFinish");
