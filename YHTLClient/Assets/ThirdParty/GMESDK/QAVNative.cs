...
namespace TencentMobileGaming
{
	public class QAVNative
	{
        ...
        public static string NATIVE_VERSION = QAVError.GMESDK_VERSION_b960be1dc3486e065a38c2cbe2aa25e698e7911d;
        static QAVNative ()
        {
	    ...
	    [DllImport(MyLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int QAVSDK_AVAudioCtrl_StartRecord(int type, 
