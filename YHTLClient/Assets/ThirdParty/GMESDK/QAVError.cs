...
namespace TencentMobileGaming
{
	public class QAVError
	{
		...
		public static int ERR_ACC_OPENFILE_FAILED = 0x7A1;         			//DEC 4001 伴奏打开文件失败
		public static int ERR_ACC_FILE_FORAMT_NOTSUPPORT = 0x7A2;           //DEC 4002 伴奏不支持的文件格式
		public static int ERR_ACC_DECODER_FAILED = 0x7A3;     			 	//DEC 4003 伴奏解码失败
		public static int ERR_ACC_BAD_PARAM = 0x7A4;         				//DEC 4004 伴奏参数错误
		public static int ERR_ACC_MEMORY_ALLOC_FAILED = 0x7A5;       		//DEC 4005 伴奏内存分配失败
		public static int ERR_ACC_CREATE_THREAD_FAILED = 0x7A6; 			//DEC 4006 伴奏创建线程失败
		public static int ERR_ACC_NOT_STARTED = 0x7A7;    					//DEC 4007 伴奏未启动
        ...
        public static string GMESDK_VERSION_b960be1dc3486e065a38c2cbe2aa25e698e7911d = "b960be1dc3486e065a38c2cbe2aa25e698e7911d";
        #endregion
    }
}