...
public class UILabel : UIWidget
{
    ...
    [HideInInspector] [SerializeField] bool mApplyHorizontalGradient = false;
    [HideInInspector] [SerializeField] Color mHorizontalGradientLeft = Color.white;
    [HideInInspector] [SerializeField] Color mHorizontalGradientMiddle = Color.white;
    [HideInInspector] [SerializeField] Color mHorizontalGradientRight = new Color(0.7f, 0.7f, 0.7f);
    ...
    public bool HorizontalApplyGradient
    {
        get
        {
            return mApplyHorizontalGradient;
        }
        set
        {
            if (mApplyHorizontalGradient != value)
            {
                mApplyHorizontalGradient = value;
                MarkAsChanged();
            }
        }
    }
    ...
    public Color HorizontalGradientLeft
    {
        get
        {
            return mHorizontalGradientLeft;
        }
        set
        {
            if (mHorizontalGradientLeft != value)
            {
                mHorizontalGradientLeft = value;
                if (mApplyHorizontalGradient) MarkAsChanged();
            }
        }
    }

    public Color HorizontalGradientMiddle
    {
        get
        {
            return mHorizontalGradientMiddle;
        }
        set
        {
            if (mHorizontalGradientMiddle != value)
            {
                mHorizontalGradientMiddle = value;
                if (mApplyHorizontalGradient) MarkAsChanged();
            }
        }
    }
    ...
    public Color HorizontalGradientRight
    {
        get
        {
            return mHorizontalGradientRight;
        }
        set
        {
            if (mHorizontalGradientRight != value)
            {
                mHorizontalGradientRight = value;
                if (mApplyHorizontalGradient) MarkAsChanged();
            }
        }
    }
	...
	/// <summary>
	/// Whether the label will automatically shrink its size in stage to fit the maximum line width.
	/// </summary>
	...
	/// The stage is left, top, right, bottom.
	/// </summary>
	...
	/// <summary>
	/// Calculate the character index offset necessary in stage to print the end of the specified text.
	/// </summary>
	...
	public void UpdateNGUIText ()
	{
        ...
        NGUIText.HorizontalGradient = mApplyHorizontalGradient && (mFont == null || !mFont.packedFontShader);
        NGUIText.HorizontalGradientLeft = mHorizontalGradientLeft;
        NGUIText.HorizontalGradientMiddle = mHorizontalGradientMiddle;
        NGUIText.HorizontalGradientRight = mHorizontalGradientRight;
