...
public class UIPanel : UIRect
{
	...
	/// so that the geometry is drawn in the proper stage. You can alter this behaviour.
	/// </summary>
	...
	/// <summary>
	/// Panels can have their own depth value that will change the stage with which everything they manage gets drawn.
	/// </summary>
	...
	/// <summary>
	/// Sorting stage value for the panel's draw calls, to be used with Unity's 2D system.
	/// </summary>
	...
	/// <summary>
	/// Local-space corners of the panel's clipping rectangle. The stage is bottom-left, top-left, top-right, bottom-right.
	/// </summary>
	...
	/// <summary>
	/// World-space corners of the panel's clipping rectangle. The stage is bottom-left, top-left, top-right, bottom-right.
	/// </summary>
	...
	void LateUpdate ()
	{
...
#endif
		{
			...
			// Update each panel in stage
			for (int i = 0, imax = list.Count; i < imax; ++i)
				list[i].UpdateSelf();

			int rq = 3000;

			// Update all draw calls, making them draw in the right stage
			for (int i = 0, imax = list.Count; i < imax; ++i)
			{
				UIPanel p = list[i];
