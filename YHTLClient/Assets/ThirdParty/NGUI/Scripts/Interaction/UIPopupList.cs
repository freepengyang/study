...
public class UIPopupList : UIWidgetContainer
{
	...
	/// <summary>
	/// What kind of click is needed in stage to open the popup list.
	/// </summary>
	...
	public void Show ()
	{
		if (enabled && NGUITools.GetActive(gameObject) && mChild == null && atlas != null && isValid && items.Count > 0)
		{
            ...
            mChild.AddComponent<UIPanel>().depth = 999;
...
#if true
            //Modifier : Luxianghua
            t.localPosition -= Vector3.up * mBackground.transform.localPosition.y;
#endif
        }
		else OnSelect(false);
	}
