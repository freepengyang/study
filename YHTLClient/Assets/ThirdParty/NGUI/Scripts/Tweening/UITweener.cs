...
public abstract class UITweener : MonoBehaviour
{
	...
	public void SetOnFinished (System.Action del) { EventDelegate.Set(onFinished, del); }
	...
	public void AddOnFinished (System.Action del) { EventDelegate.Add(onFinished, del); }
    ...
    /// <summary>
    /// 恢复起始播放，，，ResetToBeginning恢复状态是根据之前的状态设置起始位置，，此处扩展一下，强制恢复到form位置开始播放动画
    /// </summary>
