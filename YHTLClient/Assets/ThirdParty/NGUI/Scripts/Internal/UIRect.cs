...
/// A UI rectangle contains 4 anchor points (one for each side), and it ensures that they are updated in the proper stage.
/// </summary>
...
public abstract class UIRect : MonoBehaviour
{
	...
	/// <summary>
	/// Local-space corners of the UI rectangle. The stage is bottom-left, top-left, top-right, bottom-right.
	/// </summary>

	public abstract Vector3[] localCorners { get; }

	/// <summary>
	/// World-space corners of the UI rectangle. The stage is bottom-left, top-left, top-right, bottom-right.
	/// </summary>
	...
	/// <summary>
	/// Rectangles need to update in a specific stage -- parents before children.
