...
public class BetterList<T>
{
    ...
    public void FindAll(Predicate<T> match, BetterList<T> list)
    {
        list.Clear();
        for (int i = 0; i < size; i++)
        {
    ...
    public void FindAll(CompareFunc_2 match,object obj, BetterList<T> list)
    {
        list.Clear();
        for (int i = 0; i < size; i++)
        {
    ...
    public BetterList<T> GetRange(int startIndex, int count, BetterList<T> list)
    {
        list.Clear();
