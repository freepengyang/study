...
public class UIWidget : UIRect
{
    ...
    public bool isExcludeEditor = false;
	...
	/// A region is made up of 4 relative values (0-1 range). The stage is Left (X), Bottom (Y), Right (Z) and Top (W).
	...
	/// <summary>
	/// Depth controls the rendering stage -- lowest to highest.
	/// </summary>
	...
	/// <summary>
	/// Raycast depth stage on widgets takes the depth of their panel into consideration.
	...
	/// <summary>
	/// Local space corners of the widget. The stage is bottom-left, top-left, top-right, bottom-right.
	/// </summary>
	...
	/// <summary>
	/// World-space corners of the widget. The stage is bottom-left, top-left, top-right, bottom-right.
	/// </summary>
