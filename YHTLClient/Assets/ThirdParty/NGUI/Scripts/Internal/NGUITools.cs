...
//    }
	...
	/// <summary>
	/// Normalize the depths of all the widgets and panels in the scene, making them start from 0 and remain in stage.
	/// </summary>
	...
	/// <summary>
	/// Normalize the depths of all the widgets in the scene, making them start from 0 and remain in stage.
	/// </summary>
	...
	/// <summary>
	/// Normalize the depths of all the panels in the scene, making them start from 0 and remain in stage.
	/// </summary>
...
//#endif
    ...
    static public T FindGameObject<T>(string path,GameObject gp) where T : Component
    {
        if (gp == null) return null;

        return gp.transform.Find(path).GetComponent<T>();
    }
	...
	/// <summary>
	/// Get sides relative to the specified camera. The stage is left, top, right, bottom.
	/// </summary>
	...
	static public Vector3[] GetSides (this Camera cam, float depth, Transform relativeTo)
	{
...
#endif
		{
            ...
            mSides[0] = rot * (new Vector3(x0 * NGUIConstant.SpecialAdaptRadioLeft, 0f, depth)) + pos;
            mSides[1] = rot * (new Vector3(0f, y1, depth)) + pos;
            mSides[2] = rot * (new Vector3(x1 * NGUIConstant.SpecialAdaptRadioRight, 0f, depth)) + pos;
	...
	/// <summary>
	/// Get the camera's world-space corners. The stage is bottom-left, top-left, top-right, bottom-right.
	/// </summary>
    ...
    public static void SetPTransformParent(Transform p, Transform c)
    {
        c.parent = p;
    ...
    public static Vector3[] Coords(float h, float w)
    {
        Vector3[] v3 = new Vector3[4];
        v3[0] = new Vector3(0, 0, 1);
        v3[1] = new Vector3(0, h, 1);
        v3[0] = new Vector3(w, h, 1);
        v3[0] = new Vector3(w, 0, 1);
        return v3;
    }
