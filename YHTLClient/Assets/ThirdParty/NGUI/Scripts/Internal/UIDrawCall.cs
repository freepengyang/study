...
public class UIDrawCall : MonoBehaviour
{
	...
	/// <summary>
	/// List of inactive draw calls. Only used at run-time in stage to avoid object creation/destruction.
	/// </summary>
	...
	/// <summary>
	/// Renderer's sorting stage, to be used with Unity's 2D system.
	/// </summary>
